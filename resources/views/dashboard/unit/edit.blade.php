<x-dashboard title="{{ $title }}">
    ...
    <div class="row">
        <div class="col-md-8">
            <x-card>
                <x-card-title> Form Edit Unit</x-card-title>
                ...
                >
                    ...
                    <div class="col-md-8">
                        ...
                        >
                            ...
                            $data->type->category_unit_id)==$category->id)
                    ...
                    <div class="col-md-8">
                        <select id="type" class="form-select" name="type_id">
                            ...
                            $data->type_id)
                            <option value="{{ $data->type->id }}" selected>
                                {{ $data->type->name }}
                            </option>
                            @endif
                        </select>
                    ...
                    <div class="col-md-8">
                        ...
                        >
                            ...
                            @foreach($groups as $group) @if(old('group_id',
