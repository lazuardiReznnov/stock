...
<div
    wire:ignore.self
    class="modal fade"
    id="updateSparepartStockModal"
    tabindex="-1"
    aria-labelledby="updateSparepartStockModalLabel"
    aria-hidden="true"
>
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1
                    ...
                    id="updateSparepartStockModalLabel"
                >
                    Edit Sparepart Data
                </h1>
                <button
            ...
            <form wire:submit.prevent="updateSparepart">
                <div class="modal-body">
                    <div class="col-md-8 mb-3">
                        @if($oldPic)
                        <img
...
<div
    wire:ignore.self
    class="modal fade"
    id="deleteSparepartStockModal"
    tabindex="-1"
    aria-labelledby="deleteSparepartStockModalLabel"
    aria-hidden="true"
>
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1
                    class="modal-title fs-5"
                    id="deleteSparepartStockModalLabel"
                >
                    Delete Stock Data
                </h1>
                <button
            ...
            <form wire:submit.prevent="destroySparepartStock">
                <div class="modal-body">
                    <h4>Are You Sure.??</h4>
                </div>
                <div class="modal-footer">
